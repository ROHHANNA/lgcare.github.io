...
$(document).ready(function(){
	...
	window.onload = function(){
			...
			var si_01 = null; 
				...
				$inner_list.style.marginLeft = "-1000px";
			...
			function move_ul(_direction){
					//click_Event = false;
					stop_si(); 
					$inner_list.style.marginLeft = _direction =="prev" ? "0px" : "-2000px" ;
			...
			function start_si(){
				...
				//si_01= setInterval(function(){move_ul("next")}, 3200);
			}
			function stop_si(){
					if(si_01 !=0){
					clearInterval(si_01); 
	...
	function visualSlides(_targetWrap, _slides, _has_pause, _type){
	...
	var slide_01 = visualSlides(".sec_visual",".slides",false,"fade");
